...
您需要一個 LiveKit 伺服器實例來在使用者和代理之間傳輸即時媒體。最簡單的開始方式是使用免費的 [LiveKit Cloud](https://cloud.livekit.io/) 帳戶。建立一個專案並按照以下步驟使用 API 金鑰。如果您願意，您也可以[自行託管 LiveKit](https://docs.livekit.io/home/self-hosting/local.md)。
...
```
使用 [Agents playground](https://docs.livekit.io/agents/start/playground.md) 與您的代理程式對話並探索其全部多模態功能。
...
This document was rendered at 2025-05-25T02:00:34.544Z.
